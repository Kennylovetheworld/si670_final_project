...
class DetectionNetSPP(nn.Module):
    ...
    def __init__(self, spp_level=3, in_channels = 3, name = '', resnet = False):
        ...
        if resnet == True:
            ...
            self.conv_model = models.resnet34(pretrained=True)
...
class CropProposalModel(nn.Module):
    def __init__(self, spp_level = 3):
        ...
        # 512 is the number of out_channel of the last convolutional layer of resnet18/34
        ...
        self.linear_model = nn.Sequential(OrderedDict([
            ...
            ('fc2_crop', nn.Linear(1024, 512)),
            ('fc2_relu_crop', nn.ReLU()),
            ('dropout', nn.Dropout(p=0.5)),
            ('fc3_crop', nn.Linear(512, self.out_features)),
        ]))
